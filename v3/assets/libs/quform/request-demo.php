...
/**
 * Configure the companysize element
 * Filters: Trim
 * Validators: Required
 */
$companysize = new Quform_Element('companysize', 'Company Size');
$companysize->addFilter('trim');
$companysize->addValidator('required');
$form->addElement($companysize);

/**
 * Configure the budget element
 * Filters: Trim
 * Validators: Required
 */
$budget = new Quform_Element('budget', 'Approximate Budget');
$budget->addFilter('trim');
$budget->addValidator('required');
$form->addElement($budget);
